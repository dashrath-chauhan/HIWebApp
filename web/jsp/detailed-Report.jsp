<%-- 
    Document   : detailed-Report
    Created on : Feb 1, 2019, 10:50:18 AM
...
<html>
    ...
    <body>
        ...
        <div class="jumbotron vertical-center" id="jumbo-form">
            <h3 class="display-5 container">Detailed Report</h3>
            <hr class="my-5 container">
            <form class="col-lg-6 container col-md-6 col-md-offset-6" name="inquiry-form">
                <input type="text" class="form-control" id="inquiry-id" placeholder="Application Id / Inquiry Id">
                <div class="form-group col-lg-12 mt-3">
                    <div id="success-alert" class="alert alert-success" style="display:none;">
                        <strong></strong>
                    </div>
                </div>
                <button class="btn btn-dark my-4 btn-block" type="button" id="detailedReport">Generate Report</button>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/detailedReport.js"></script>
