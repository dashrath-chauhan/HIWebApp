...
<html>
    <head>
        ...
        <title>View Inquiry - Heer International</title>
...
<!--                            <a class="dropdown-item" href="<%=request.getContextPath()%>/jsp/inquiry-details.jsp">Inquiry Details</a>
                ...
                <div class="row">
                    <!--                        <form class="form-inline">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    <input id="filter" data-table="order-table" type="search" class="form-control" placeholder="Inquiry Id">
                                                </div>
                                                <button type="submit" class="btn btn-primary mx-sm-3 mb-2 mr-4" id="update">Update</button>
                                                <button type="submit" class="btn btn-primary mx-sm-3 mb-2" id="insert-details">Insert Details</button>
                                            </form>-->
                    <hr class="my-5">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/view-inquiry.js"></script>
