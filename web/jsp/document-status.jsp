...
<html>
    <head>
        ...
        <title>Document Status - Heer International</title>
    ...
    <body>
        ...
        <div class="jumbotron vertical-center" id="jumbo-form">
            <h3 class="display-5 container">Documents Status</h3>
            ...
            <form class="col-lg-6 container col-md-6 col-md-offset-6" name="inquiry-form">
                ...
                <button class="btn btn-dark my-4 btn-block" type="button" id="getData">Get Documents List</button>
                <hr class="my-5">
