...
<html>
    ...
    <body>
        ...
        <div class="jumbotron vertical-center" id="jumbo-form">
            ...
            <form class="col-lg-6 container col-md-6 col-md-offset-6" method="post" action="http://localhost:46854/HIRestApp/webresources/inquiry.documents/uploadFile" enctype="multipart/form-data">
                <div class="row">
        ...
        <script>
                            function send() {
                                ...
                                xhttp.open("POST", "http://localhost:46854/HIRestApp/webresources/inquiry.documents/uploadFile", false)
