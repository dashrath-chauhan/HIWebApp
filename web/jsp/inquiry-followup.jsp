<%-- 
    Document   : inquiry-followup
    Created on : Jan 28, 2019, 7:37:31 AM
...
<html>
    <head>
        ...
        <title>Inquiry FollowUp - Heer International</title>
    ...
    <body>
        ...
        <div class="jumbotron vertical-center" id="jumbo-form">
            <h3 class="display-5 container">Inquiries FollowUp</h3>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/inquiry-followup.js"></script>
