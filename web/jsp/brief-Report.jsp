<%-- 
    Document   : basic-Report
    Created on : Jan 21, 2019, 6:23:22 PM
...
<html>
    <head>
        ...
        <title>Report - Heer International</title>
...
<!--                            <a class="dropdown-item" href="<%=request.getContextPath()%>/jsp/inquiry-details.jsp">Inquiry Details</a>
        ...
        <div class="jumbotron vertical-center" id="jumbo-form">
            <h3 class="display-5 container">Brief Report</h3>
            <hr class="my-5 container">
            <form class="col-lg-6 container col-md-6 col-md-offset-6" name="inquiry-form">
                <div class="container form-group col-md-12">
                    <input type="text" id="dateFrom" class="form-control col-md-12" placeholder="Date From">
                    
                </div>
                <div class="container form-group col-md-12">
                    
                    <input type="text" id="dateTo" class="form-control col-md-12" placeholder="Date To">
                </div>
                <div class="container form-group col-md-12">
                ...
                <button class="btn btn-dark my-4 btn-block" type="button" id="createReport">Generate Report</button>
